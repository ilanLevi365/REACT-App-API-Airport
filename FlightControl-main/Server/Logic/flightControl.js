//מסך ניהול של טיסות
//שתי הפונקציות של הכנסה לרשימת ההמראה או לרשימת הנחיתה נמצאות בסוף העמוד
...
class Logic {
    ...
    //פונק זה מעביר את הטיסה לשלב הבא ב שערים ומחזיר את הטיסות הבאות כדי להתקדם;
    arrivalChangeLeg(flight) {
        return new Promise((res, rej) => {
            ...
            //עדכון הטיסה הבאה על בסיס הרגל הנוכחית:
            ...
            if (flight.currentLeg < arrivalLeg6) {
               ...
               //מכניס את פירטי הטיסה לטבלת הדאטהבייס
                //log this action:
    ...
    registerArrivalFlight(currentFlight) {
        ...
        if (Data.landingProcess[leg1].flights.length < Data.landingProcess[leg1].capacity) {
            ...
            //console.log(`${currentFlight.name} arrival entered leg 1`);הגעה נכנסה רגל 1
            //להתחיל לעוף על רגל 1.
            this.completeLeg(currentFlight, Data.landingProcess[leg1].crossingTime);
        }
        else {
            //טיסה באזור טיסות נכנסות מוכנות להמשך.
            currentFlight.isReady = true;
            currentFlight.currentLeg = 0;
            //נחיתה קריטית מוצבת בחזית.
            if (currentFlight.isCritical) {
            ...
            //console.log(`${currentFlight.name} arrival entered incoming`);ההגעה נכנסה נכנסת
        }
        //מכניס את פירטי הטיסה לטבלת הדאטהבייס
